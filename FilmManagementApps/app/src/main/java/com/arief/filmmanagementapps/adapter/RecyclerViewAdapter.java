...
import com.arief.filmmanagementapps.activity.ActivityUpdate;
...
//    Konstruktor
    ...
    public void onBindViewHolder(@NonNull RecyclerViewAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        final String Resolusi = listFilm.get(position).getResolusi();
...
//        Memasukan Kedalam Holder
        ...
        holder.Resolusi.setText(Resolusi);
...
//        SetOnClickListener
                    ...
                    public void onClick(DialogInterface dialogInterface, int pilihan) {
                       switch (pilihan){
                           case 0:
                               ...
                               bundle.putString("dataResolusi",listFilm.get(position).getResolusi());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView Resolusi;
        ...
        public ViewHolder(@NonNull View itemView, dataListener listener) {
            ...
            Resolusi = itemView.findViewById(R.id.show_resolusi);
        }
    }
}
